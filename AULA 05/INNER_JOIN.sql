...
CREATE TABLE venda (
DUPLIC CHAR(8) NOT NULL PRIMARY KEY,
...
SELECT CLIENTE.NOME, VENDA.VALOR, MIN(VENDA.VALOR) AS MENOR_VENDA
FROM CLIENTE INNER JOIN VENDA
ON CLIENTE.CODCLI = VENDA.CODCLI
GROUP BY CLIENTE.NOME, VENDA.DUPLIC;

SELECT CLIENTE.NOME, VENDA.VALOR, MAX(VENDA.VALOR) AS MENOR_VENDA
FROM CLIENTE INNER JOIN VENDA
ON CLIENTE.CODCLI = VENDA.CODCLI
GROUP BY CLIENTE.NOME, VENDA.DUPLIC;
...
-- 3
SELECT CLIENTE.NOME, VENDA.DUPLIC, VENDA.VENCTO, VENDA.VALOR
FROM CLIENTE INNER JOIN VENDA ON CLIENTE.CODCLI = VENDA.CODCLI
WHERE MONTH(VENDA.VENCTO) = 10
ORDER BY CLIENTE.NOME, VENDA.VENCTO;

-- 4
SELECT CLIENTE.NOME,
COUNT(VENDA.DUPLIC) AS QUANTIDADE_TITULOS,
SUM(VENDA.VALOR) AS TOTAL_DEVEDOR
FROM CLIENTE INNER JOIN VENDA ON CLIENTE.CODCLI = VENDA.CODCLI
GROUP BY CLIENTE.NOME
ORDER BY CLIENTE.NOME;
...
COUNT(VENDA.DUPLIC) AS QTDE_TITULOS,
SUM(VENDA.VALOR) AS VALOR_TOTAL
FROM CLIENTE INNER JOIN VENDA ON CLIENTE.CODCLI = VENDA.CODCLI
GROUP BY CLIENTE.NOME
ORDER BY CLIENTE.NOME;
...
-- 6
SELECT CLIENTE.NOME AS CLIENTE,
COUNT(VENDA.DUPLIC) AS VENCIDOS
FROM CLIENTE INNER JOIN VENDA ON CLIENTE.CODCLI = VENDA.CODCLI
...
SELECT CLIENTE.NOME AS CLIENTE,
VENDA.DUPLIC,
VENDA.VALOR AS VALOR_ORIGINAL,
ROUND(VENDA.VALOR * 0.10, 2) AS JUROS,
ROUND(VENDA.VALOR * 1.10, 2) AS VALOR_TOTAL
FROM CLIENTE INNER JOIN VENDA ON CLIENTE.CODCLI = VENDA.CODCLI
WHERE VENDA.VENCTO < '1999-12-31'
ORDER BY CLIENTE.NOME, VENDA.DUPLIC;
